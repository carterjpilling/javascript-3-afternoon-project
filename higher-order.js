...
need to have an index to tell say index 0 in price and indx in tax times eachother. 
...
// let bobsTotal = purchases.reduce(function(acc, e) {
//   if(e.owner === "bob")
//   return acc + obj.price
// // })
// function bobSum(total, obj) {
//   if (obj.owner === "Bob") {
//     // debugger;
...
//   return total
// }
// let bobsTotal = purchases.reduce(bobSum, 0)
let bobsTotal = purchases.reduce((acc, obj) => {
  if (obj.owner === "Bob") {
    return acc + obj.price
  } 
  return acc
...
// let bobsTotal = purchase; let a = bobsTotal.reduce((acc,obj) => acc + obj.price,0)
